...
<div id="login_form" class="container justify-content-center col-md-12">
    ...
    <div class="form-group">
        ...
        <input id="inputName" type="text" class="form-control" placeholder="Enter your name" required>
    </div>

    <div class="form-group">
        <label for="inputSurname">Cognome</label>
        <input id="inputSurname" type="text" class="form-control" placeholder="Enter your surname" required>
    </div>

    <div class="form-group">
        <label for="gender_fluid">Sesso</label>
        <select id="gender_fluid" class="form-select" aria-label="Default select example" style="width: 100%" required>
