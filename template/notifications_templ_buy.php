            ...
            <tr>
                ...
                <td class="notif_head_info">
                    <table>
                        <tbody>
                            <tr>
                                <td class="td_pay"><strong>€ <?php echo $templateParams["amount"] ?></strong> Paid</td>
                                <td class="td_thx" >Thanks for using <span>luminosita.food</span></td>
                            </tr>
                        </tbody>
                    </table>
                </td>
                                    ...
                                    <table >
                                        <tbody>
                                            <?php foreach ($templateParams["body"] as $value): ?>
                                                <tr>
                                                    <td class="td_name"><?php echo $value["name"]; ?></td>
                                                    <td class="td_price"><?php echo $value["price"]."€"; ?></td>
                                                    <td class="td_count"><?php echo "x".$value["count"]; ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                            <tr>
                                                <td class="td_amount_lbl">Amount paid</td>
                                                <td class="td_amount"><?php echo $templateParams["amount"]."€"; ?></td>
                                                <td class="td_total"><?php echo "x".$templateParams["count"]; ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
